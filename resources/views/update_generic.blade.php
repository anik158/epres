                    ...
                    <form action="/generics_update/{{$generic->id}}" method="POST" class="form-horizontal">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$generic->name}}"  class="form-control" id="name" name="name">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea type="text" id="indication" class="form-control" name="indication">{{$generic->indication}}</textarea><br>
                            </div>
                        </div>
